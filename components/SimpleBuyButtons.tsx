  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-6">
      <div className="text-center mb-8">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-2 font-battle tracking-tight">
          Show Your Support
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Israel Button */}
        <motion.div 
          className="bg-glass rounded-2xl p-6 flex flex-col items-center border border-blue-500/30"
          whileHover={{ scale: 1.02 }}
          transition={{ duration: 0.2 }}
        >
          <FlagIsrael />
          <div className="mt-4 mb-2 text-lg font-tech text-blue-300">Israel Token</div>
          <div className="mb-4 text-2xl font-space text-white">
        ...
        {/* Iran Button */}
        <motion.div 
          className="bg-glass rounded-2xl p-6 flex flex-col items-center border border-green-500/30"
          whileHover={{ scale: 1.02 }}
          transition={{ duration: 0.2 }}
        >
          <FlagIran />
      ...
      <div className="mt-8 text-center">
        <div className="bg-glass rounded-xl p-4 border border-cyan-400/20">
          <p className="text-sm text-gray-300 font-tech mb-2">
            <ArrowSquareOut size={16} className="inline mr-2 text-cyan-400" />
