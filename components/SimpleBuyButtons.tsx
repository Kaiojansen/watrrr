  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-6">
      <div className="text-center mb-8">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-2 font-battle tracking-tight gradient-text glow-text">
          Show Your Support
        </h2>
        <p className="text-base text-gray-400 font-future text-shadow-cyber">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Israel Button */}
        <motion.div 
          className="bg-gradient-to-br from-blue-900/60 via-blue-800/40 to-blue-900/60 backdrop-blur-sm rounded-2xl p-6 flex flex-col items-center border border-blue-500/40 shadow-2xl"
          whileHover={{ scale: 1.02 }}
          transition={{ duration: 0.2 }}
        >
          <FlagIsrael />
          <div className="mt-4 mb-2 text-lg font-tech text-blue-300">Israel Token</div>
          <div className="mb-4 text-2xl font-space text-white gradient-text">
        ...
        {/* Iran Button */}
        <motion.div 
          className="bg-gradient-to-br from-green-900/60 via-green-800/40 to-green-900/60 backdrop-blur-sm rounded-2xl p-6 flex flex-col items-center border border-green-500/40 shadow-2xl"
          whileHover={{ scale: 1.02 }}
          transition={{ duration: 0.2 }}
        >
          <FlagIran />
      ...
      <div className="mt-8 text-center">
        <div className="bg-gradient-to-r from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-xl p-4 border border-cyan-400/30 shadow-lg">
