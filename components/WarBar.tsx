  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-6">
      <div className="text-center mb-8">
        <h2 className="text-4xl md:text-5xl font-bold text-gray-200 mb-2 font-battle tracking-tight gradient-text">
          Community Sentiment
        </h2>
        <p className="text-base text-cyan-300 font-tech uppercase tracking-widest animate-pulse">
          {phrase}
        </p>
      </div>
      ...
      <div className="relative h-20 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 rounded-xl overflow-hidden border border-cyan-400/20 flex items-center shadow-2xl">
        ...
        >
          <span className="text-gray-200 font-bold px-4 text-lg font-space">
        ...
        <div className="absolute bottom-2 left-4 right-4 h-2 bg-gray-800/80 rounded-full overflow-hidden border border-cyan-400/15">
          <div
        ...
        <div className="absolute top-0 left-1/2 h-full w-1 bg-gradient-to-b from-transparent via-cyan-400/40 to-transparent transform -translate-x-1/2" />
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-8">
        <div className="bg-glass rounded-xl p-5 flex flex-col items-center border border-blue-500/20 pulse-card hover:scale-105 transition-transform duration-200 bg-gradient-to-br from-blue-900/40 to-blue-800/20">
          ...
          <div className="text-2xl font-space text-gray-200 mt-1 gradient-text">{israelLiquidity.toLocaleString()} SOL</div>
        </div>
        <div className="bg-glass rounded-xl p-5 flex flex-col items-center border border-green-500/20 pulse-card hover:scale-105 transition-transform duration-200 bg-gradient-to-br from-green-900/40 to-green-800/20">
          ...
          <div className="text-2xl font-space text-gray-200 mt-1 gradient-text">{iranLiquidity.toLocaleString()} SOL</div>
        </div>
        <div className="bg-glass rounded-xl p-5 flex flex-col items-center border border-yellow-400/15 hover:scale-105 transition-transform duration-200 bg-gradient-to-br from-yellow-900/40 to-yellow-800/20">
          ...
          <div className="text-2xl font-space text-gray-200 mt-1 gradient-text">{leading}</div>
        </div>
        <div className="bg-glass rounded-xl p-5 flex flex-col items-center border border-cyan-400/15 hover:scale-105 transition-transform duration-200 bg-gradient-to-br from-cyan-900/40 to-cyan-800/20">
          ...
          <div className="text-2xl font-space text-gray-200 mt-1 gradient-text">{(Math.abs(israelLiquidity - iranLiquidity)).toLocaleString()} SOL</div>
        </div>
      </div>
    </div>
  )
